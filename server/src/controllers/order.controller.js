...
export const createOrder = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    failedCheckoutTotal.inc();
    end(); // ghi nhận latency kể cả khi thất bại
    throw err; // để asyncHandler / error middleware xử lý tiếp
  }
});
